...
class Query_Config(TypedDict, total=False):
    ...
    method: Literal['statistics', 'detection', 'exploration']
...
DEFAULT_QUERY_CONFIG: Query_Config = {
    "log_name": "example_log",
    "storage_namespace": "siesta",
    "method": "statistics", #"statistics", "detection", "exploration"
    "query": {
        "pattern": "", # eg. A[pos=?1]+ B[pos=?1+5] C*
        "explore_mode": "accurate", # or "fast" or "hybrid"
        "explore_k": 10, # for hybrid mode, number of candidates to explore accurately (0 = fast exploration)
    },
